                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"> * Modifier Catégorie * </h1>
                            </div>
                            ...
                            <input type="text" style="color :transparent ; background:transparent ; border-color:transparent"  name="id" id="id" class="form-control validate" value="<?php echo $categorie['id']; ?>" maxlength="20">
                               ...
                               <input type="submit" href="afficherCategorieBack.php" class="btn btn-primary btn-user btn-block" value="Modifier Catégorie !" ></input>
                            </form>
                            <hr>
