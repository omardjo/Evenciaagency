                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="img-profile rounded-circle" src="../Back/img/user.svg"> <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['username']; ?></span>

                                </a>
                                <!-- Dropdown - User Information -->
                                
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="<?php echo $SESSION['lienPage'] ?>">
                                        <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Profile
                                    </a>
                                    <a class="dropdown-item" href="../../Views/user/logoutB.php">
                ...
                <?php else : ?>
                    ...
                    <div class="input-group">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <a href="../user/signinB.php" class="btn btn-primary py-2 px-3 me-3 animated fadeIn"><i class="fa fa-id-card" ></i> Sign in </a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary" href="./user/logoutB.php">Logout</a>
                            </div>
                        </div>
                    </div>
                </div> -->
