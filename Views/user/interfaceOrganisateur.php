...
<body>
    <div class="h3 mb-2 text-gray-800"">
        ...
        <h2>
            <center><img class="img" src="../event/images/organisateur-icon.png"/> Interface Organisateur </center>
        </h2>
        <h1 >
          <center>  Bienvenu Cher Organisateur ! </center>
        </h1>
<div style="margin-top:60px;margin-left:430px" > 
        <button type="button" class="btn btn-dark mb-2 mr-2">
<a href="../event/afficherEventOrganisateurBack.php">  
