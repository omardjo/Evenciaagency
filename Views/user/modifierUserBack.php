...
if (isset($_POST['nom']) && isset($_POST['prenom'])) {
    if (!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty ($_POST['role']) && !empty($_POST['email']) && !empty ($_POST['tel']) && !empty ($_POST['password'])) {
        $user = new user($_POST['nom'], $_POST['prenom'],$role,$_POST['email'],$_POST['tel'],$_POST['password']);
...
<?php
     ...
     <select name="role" id="" class="form-control validate" >
     ...
     <option value="participant" name="role"> Participant</option>
         ...
         <option value="organisateur" name="role"> Organisateur</option>
                               ...
                               <input type="submit" href="afficherUserBack.php" class="btn btn-primary btn-user btn-block" value="Modifier l'Utilisateur !" ></input>
                            </form>
                            <hr>
