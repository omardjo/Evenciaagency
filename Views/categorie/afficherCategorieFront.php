        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4"> Event's Categories </h1> 
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>These are the different Event's categories represented by Evencia Agency. <br> You can check the Event listing according to each category choosed .</p>
                </div>
                <div class="row g-4">
                <?php
			...
			?>	
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="../event/afficherEventperCategorieFront.php?CategorieId=<?php echo $categorie['id']?>&event_id">
                            <div class="rounded p-4">
                                <div class="icon mb-3">
                                    <img class="img-fluid" src="../Front/img/icon-calender.png" alt="Icon">
                                </div>
                    ...
                    <?php } ?>
                            ...
                            <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                                <a class="btn btn-primary py-3 px-5" href="afficherCategorieFront.php"><i class="fa fa-search" aria-hidden="true"></i> Browse More categories </a>
                            </div>
         </div>
